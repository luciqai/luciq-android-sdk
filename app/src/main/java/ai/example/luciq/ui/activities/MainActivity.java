...
import ai.luciq.library.logging.LuciqNetworkLog;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Luciq logs
        LuciqLog.d("MainActivity - Created");
    ...
    public void onShowLiveOnboardingMessageClicked(View view) {
        Luciq.showWelcomeMessage(WelcomeMessage.State.LIVE);
    }
    ...
    public void onShowLuciqClicked(View view) {
